...
const PromoSection = () => {
  return (
    <section
      className="flex flex-col items-center justify-center  px-4 py-15 md:py-0 text-center bg-cover bg-center bg-no-repeat  "
      ...
      <div className=" bg-opacity-50 rounded-lg w-full mt-4 ">
        ...
        <div className="relative w-full aspect-square mx-auto flex items-center justify-between h-[40vh] sm:h-[90vh] sm:pb-16 sm:pt-6">
            ...
            <div className="relative   mx-auto aspect-square">
              ...
              <div className="absolute inset-0 flex items-center justify-center z-10">
                <div className="bg-white  text-black rounded-full lg:w-[60%] lg:h-[60%]  w-[55%] h-[55%] p-4 flex flex-col items-center justify-center  xs:p-2 sm:p-4 md:p-6 lg:p-4 xl:p-2 ">
                  <p className="w-full text-center text-black font-poppins font-extrabold sm:text-[2rem] xl:text-2xl lg:text-[1.0rem] lg:leading-[150%] xl:leading-[180%]  leading-[150%] text-xs sm:mt-8 md:text-[1.2rem] sm:text-2xl md:mt-3  xl:mt-2  p-2 xl:p-2">
                  Promo runs from June  <br /> 7th - July 6th, 2025
                  </p>
          ...
          <div className="bg-[#F25B0A] rounded-full w-[60%] h-[60%] opacity-70"></div>
              ...
              <div className="absolute z-20 bottom-1/5 right-1/4 transform translate-x-1/2 translate-y-1/4 xl:right-1/5">
                <div className="relative w-20 h-20 sm:w-25 sm:h-25 md:w-30 md:h-30 lg:w-25 lg:h-25 xl:w-37 xl:h-37">
                  <Image
                    src="/uzbek.png"
                    alt="Rice dish"
